signInWidgetConfig = {
  ...
  idps: [
    {% if page.okta.googleIdpId   != "None" %}{type: 'GOOGLE',   id: '{{ page.okta.googleIdpId }}'},
    {% endif %}{% if page.okta.facebookIdpId != "None" %}{type: 'FACEBOOK', id: '{{ page.okta.facebookIdpId }}'},
    {% endif %}{% if page.okta.linkedinIdpId != "None" %}{type: 'LINKEDIN', id: '{{ page.okta.linkedinIdpId }}'},
{% endif %}],
...
if(signInWidget.token.hasTokensInUrl()) {
  ...
  signInWidget.renderEl({el: '#nav-social-tab-widget'}, widgetSuccessCallback, widgetErrorCallback);
}
