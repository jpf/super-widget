signInWidgetConfig = {
  ...
  i18n: {
    ...
    'en': {
      'primaryauth.title': 'Custom Title',        // Changes the sign in text
      'primaryauth.submit': 'Custom Button',      // Changes the sign in button
      'primaryauth.username.placeholder': 'Member ID',
      'primaryauth.password.placeholder': 'Secret Code',
...
if(signInWidget.token.hasTokensInUrl()) {
  ...
  signInWidget.renderEl({el: '#nav-custom-tab-widget'}, widgetSuccessCallback, widgetErrorCallback);
}
